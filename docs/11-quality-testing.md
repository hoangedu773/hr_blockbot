...
|---|---|---|---|
| `domain/` — state machine F2 | **100% state-machine transition** | `pnpm test:coverage` (scope `domain/`) | Mỗi cạnh hợp pháp **và** mỗi cạnh bất hợp pháp phải có case. Đây là luật ship — §8.3 |
